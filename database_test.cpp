...
void TestFind(){
	...
	//Find with not equal condition
	{
		...
		vector<string> v = {"2017-01-01 New Year", "2017-05-09 Holiday", "2017-06-10 Mary's Birthday", "2017-07-10 Gary's Birthday"};
	...
	//Find with empty condition
	{
		...
		vector<string> v2 = {"2017-01-01 New Year", "2017-05-09 Holiday", "2017-06-10 Mary's Birthday", "2017-07-10 Gary's Birthday"};
	...
	//Find with OR and > condition
	{
		...
		vector<string> v5 = {"2017-05-09 Holiday", "2017-06-10 Mary's Birthday", "2017-07-10 Gary's Birthday"};
